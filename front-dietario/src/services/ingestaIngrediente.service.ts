...
class IngestaIngredienteService {
  post(data: IngestaIngrediente): Promise<any> {
    return http
      .post(`/ingesta_ingrediente/`, data)
  ...
  getOne(id_ingrediente: number, id_ingesta: number): Promise<any> {
    return http
      .get(
  ...
  update(id_ingrediente: number, id_ingesta: number, data: any): Promise<any> {
    return http
      .put(
        `/ingesta_ingrediente/ingrediente/${id_ingrediente}/ingesta/${id_ingesta}`,
        data
  ...
  delete(id_ingrediente: number, id_ingesta: number): Promise<any> {
    return http
      .delete(
        `/ingesta_ingrediente/ingrediente/${id_ingrediente}/ingesta/${id_ingesta}`
      )
