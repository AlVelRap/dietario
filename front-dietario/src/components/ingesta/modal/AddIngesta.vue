    ...
    <div class="modal-dialog">
      <div class="modal-content">
          ...
          <form>
            <div class="mb-3">
              ...
              <div class="input-group mb-3">
                <input type="text" class="form-control" id="input-ingesta" aria-describedby="icon-input-ingesta"
                  aria-label="Añadir nombre ingesta" v-model="nombre" />
        ...
        <div class="modal-footer text-center">
          <button type="button" class="btn btn-primary" @click="postIngesta" data-bs-dismiss="modal">
            Añadir
          </button>
